...
1.
    ...
    **Authors:** Junyan Ye, Zhutao Lv, Weijia Li, Jinhua Yu, Haote Yang, Huaping Zhong, and Conghui He
    ...
    [Paper](https://arxiv.org/pdf/2408.05475) | [Code](https://github.com/yejy53/EP-BEV) | [BibTeX](./citations/ye2024cross)
    
    ---

1.
    ### Cross-View Image Matching for Geo-Localization in Urban Environments (CVPR 2017)
    ...
    **Authors:** Yicong Tian, Chen Chen, Mubarak Shah
    ...
    [Paper](https://openaccess.thecvf.com/content_cvpr_2017/papers/Tian_Cross-View_Image_Matching_CVPR_2017_paper.pdf) | [BibTeX](./citations/tian2017cross)
...
1. 
    ...
    **Authors:** Nam N. Vo & James Hays
    ...
    [Paper](https://link.springer.com/content/pdf/10.1007/978-3-319-46448-0_30.pdf?pdf=inline%20link) | [BibTeX](./citations/vo2016localizing)
...
1.
    ...
    **Authors:** Scott Workman, Richard Souvenir, Nathan Jacobs
    ...
    [Paper](https://openaccess.thecvf.com/content_iccv_2015/papers/Workman_Wide-Area_Image_Geolocalization_ICCV_2015_paper.pdf) | [BibTeX](./citations/Workman_2015_ICCV)
